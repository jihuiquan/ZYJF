 ...
 */
package com.dynamic.foundations.common.io;

import android.os.Build;
import com.dynamic.foundations.common.io.stream.*;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.dynamic.foundations.common.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.dynamic.foundations.common.io.stream.ByteArrayOutputStream output = new com.dynamic.foundations.common.io.stream.ByteArrayOutputStream();
        copy(input, output);
