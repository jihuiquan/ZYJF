 ...
 * lazy-dependency-com.buddhism.foundation.injection of interface types; class types require eager-dependency-com.buddhism.foundation.injection.
 * <p/>
 * Example usage: <code>
...
public class DependencyInjectingObjectFactory {
    ...
    public <T> T getObject(Class<T> aClass) {
        return getObject(aClass, true);
    }

    public <T> T getObject(Class<T> aClass, boolean throwError) {
