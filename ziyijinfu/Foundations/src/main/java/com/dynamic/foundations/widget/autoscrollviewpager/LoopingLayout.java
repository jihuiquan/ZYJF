 ...
 */
public class LoopingLayout extends RelativeLayout implements RecyclingPagerAdapter.DataChangeListener {
...
//    private boolean isBorderAnimation = true;
    ...
    public LoopingLayout(Context context) {
        this(context, null);
    }

    public LoopingLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoopingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//
//        if(indicatorType == 0)
            LayoutInflater.from(context).inflate(R.layout.default_viewpage, this, true);
...
//            LayoutInflater.from(context).inflate(R.layout.layout_anim_line_indicator, this, true);
    ...
    public <T extends View> void addSlider(T imageContent) {
...
//            mIndicator.notifyDataSetChanged();
    ...
    public static class ScrollHandler extends Handler{
        public WeakReference<LoopingLayout> mLeakActivityRef;

        public ScrollHandler(LoopingLayout loopingLayout) {
            mLeakActivityRef = new WeakReference<LoopingLayout>(loopingLayout);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            LoopingLayout loopingLayout = mLeakActivityRef.get();
            if(loopingLayout != null){
                switch (msg.what) {
                    case MSG_WHAT:
                        loopingLayout.scrollOnce();
                        loopingLayout.sendScrollMessage();
                    default:
                        break;
                }
            }
