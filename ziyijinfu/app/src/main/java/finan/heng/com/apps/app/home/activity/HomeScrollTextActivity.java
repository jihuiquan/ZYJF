...
public class HomeScrollTextActivity extends BaseActivity {
    ...
    private void initView() {
        mPullToRefreshView = (SmartRefreshLayout) findViewById(R.id.activity_scroll_text_pull);
        mRecyclerView = (RecyclerView) findViewById(R.id.activity_scroll_text_recyclerview);
    ...
    class HomeScrollTextAdapter extends RecyclerView.Adapter<HomeScrollTextAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View itemView) {
                ...
                mTvTime = (TextView) itemView.findViewById(R.id.home_scroll_time);
                mTvTitle = (TextView) itemView.findViewById(R.id.home_scroll_title);
                imgPic = (ImageView) itemView.findViewById(R.id.home_scroll_imageview);
            }
        }
    }
