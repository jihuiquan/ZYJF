...
public class ReviseLoginMimaActivity extends BaseActivity implements View.OnClickListener, TextWatcher {
    ...
    private boolean   oldShow = true, newShow =true;
    ...
    private void initView() {
        mEtOld = (EditText) findViewById(R.id.et_oldkey);
        mEtNew = (EditText) findViewById(R.id.et_newkey);
        mBtn = (Button) findViewById(R.id.bt_revise);
        mIv1 = (ImageView) findViewById(R.id.activity_reviseloginmima1);
        mIv2 = (ImageView) findViewById(R.id.activity_reviseloginmima2);
        findViewById(R.id.tv_retrive_pwd).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ReviseLoginMimaActivity.this, ForgetPasswordActivity2.class));
                finish();
            }
        });
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bt_revise:
                ...
                new HttpHelper().changeLoginPassword(s, s1).subscribe(new Action1<ChangeLoginPasswordResponse>() {
                    @Override
