...
public class ShiMingRenZhengActivity extends BaseActivity implements View.OnClickListener, TextWatcher {
  ...
  android.support.v7.app.AlertDialog alertDialog;
    ...
    private void initView() {
        ...
        TextView tvXieYi = (TextView) findViewById(R.id.tv_xieyi);
        mEt_shenfennum = (EditText) findViewById(R.id.et_shenfennum);
        mEt_yinhangcard = (EditText) findViewById(R.id.et_yinhangcard);
        mEt_yuliu_phone = (EditText) findViewById(R.id.et_yuliu_phone);
       checkBox= (CheckBox) findViewById(R.id.iv_select4);
        mEt_yanzhengma = (EditText) findViewById(R.id.et_yanzhengma);
        mBt_shenfenyanzheng = (Button) findViewById(R.id.bt_shenfenyanzheng);
        mTv_getyanzhengma = (TextView) findViewById(R.id.tv_getyanzhengma);
        mRl_item = (RelativeLayout) findViewById(R.id.rl_item);
        if (getIntent().getBooleanExtra("need",true)){
            Toast.makeText(this,"您还未实名认证,请先实名认证",Toast.LENGTH_SHORT).show();
        }
    ...
    private void ruleName() {
        ...
        if (mEt_shenfennum.getText().toString().length() == 18) {
            ...
            new HttpHelper().ruleName(mEt_name.getText().toString(), mBankId, mEt_shenfennum.getText().toString(), mEt_yinhangcard.getText().toString(), mEt_yuliu_phone.getText().toString(), mEt_yanzhengma.getText().toString()).subscribe(new Action1<RuleNameResponse>() {
                @Override
