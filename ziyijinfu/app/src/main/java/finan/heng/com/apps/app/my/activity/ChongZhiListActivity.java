...
public class ChongZhiListActivity extends BaseActivity {
    ...
    private void initView() {
        mListView = (ListView) findViewById(R.id.activity_list_chongzhi_lv);

        new HttpHelper().getPayStyle().subscribe(new Action1<GetPayStyleResponse>() {
            @Override
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            ImageView iv = (ImageView) view.findViewById(R.id.iv_platform_logo);
            TextView name = (TextView) view.findViewById(R.id.tv_platform_name);
            TextView title = (TextView) view.findViewById(R.id.tv_platform_hint);
...
//                    intent.putExtra(IConstants.Extra.EXTRA_CASH, StringUtils.trimToEmpty(getIntent().getExtras().getString(IConstants.Extra.EXTRA_CASH)));
