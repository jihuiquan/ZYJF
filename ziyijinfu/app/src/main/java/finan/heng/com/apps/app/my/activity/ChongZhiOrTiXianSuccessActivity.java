...
public class ChongZhiOrTiXianSuccessActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initData() {
        if (type == 1) {
            ...
            mIvOne.setImageResource(R.mipmap.ic_withdraw_step);
            mIvTwo.setImageResource(R.mipmap.ic_withdraw_step);
            mIvThree.setImageResource(R.mipmap.ic_withdraw_step);
    ...
    private void initView() {
        mTvMoney = (TextView) findViewById(R.id.chongzhi_success_money);
        mTvBank = (TextView) findViewById(R.id.chongzhi_success_bank);
        mIvBank = (ImageView) findViewById(R.id.chongzhi_success_bankicon);
        rlFinish = (RelativeLayout) findViewById(R.id.menu_layout);

        //图表显示进度
        mIvOne = (ImageView) findViewById(R.id.iv_step_one);
        mIvTwo = (ImageView) findViewById(R.id.iv_step_two);
        mIvThree = (ImageView) findViewById(R.id.iv_step_three);
        lineOne = findViewById(R.id.view_line_one);
        lineTwo = findViewById(R.id.view_line_two);

        tvThree = (TextView) findViewById(R.id.chongzhi_success_tv_three);
        tvTwo = (TextView) findViewById(R.id.chongzhi_success_tv_two);
        tvOne = (TextView) findViewById(R.id.chongzhi_success_tv_one);

        btn = (Button) findViewById(R.id.activity_chongzhi_success_btn);
