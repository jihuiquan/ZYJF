...
public class ForgetPasswordActivity extends BaseActivity implements View.OnClickListener, TextWatcher {
    ...
    private void initView() {
        ...
        mEtPhone = (EditText) findViewById(R.id.activity_find_password_phone);
        mBtn = (Button) findViewById(R.id.activity_find_password_btn);
    }
    ...
    private void goto2() {
        new HttpHelper()
            ...
            public void call(GetMessageCodeResponse getMessageCodeResponse) {
                ...
                intent.putExtra("img", mEtPicCode.getText().toString());
