...
public class InviteFriendFinanceAdapter extends RecyclerView.Adapter<InviteFriendFinanceAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            mTvOne = (TextView) itemView.findViewById(R.id.invite_finance_item_tv_one);
            mTvTwo = (TextView) itemView.findViewById(R.id.invite_finance_item_tv_two);
            mTvThree = (TextView) itemView.findViewById(R.id.invite_finance_item_tv_three);
        }
    }
}
