...
public class RetrofitClient {
    ...
    public RetrofitClient(boolean noUse) {
        Retrofit.Builder builder = new Retrofit.Builder();
//        builder.addConverterFactory(RawJsonConverterFactory.create() );
        builder.addCallAdapterFactory(RxJavaCallAdapterFactory.create());
        builder.baseUrl(URLHelper.getInstance().URL);
    ...
    private OkHttpClient getHttpClient() {
        ...
        HttpsURLConnection.setDefaultSSLSocketFactory(getSslScoketFactory());
            ...
            return new OkHttpClient.Builder().connectTimeout(60, TimeUnit.SECONDS).readTimeout(60, TimeUnit.SECONDS).writeTimeout(20, TimeUnit.SECONDS).addInterceptor(logging).addInterceptor(new Interceptor() {
                ...
                public Response intercept(Chain chain) throws IOException {
                    Request request = chain.request().newBuilder()
                            ...
                            .build();
                    Logger.i("header" + IConstants.Header.DEVICEMODEL + " = " + KeyHolder.getInstance().getDeviceModel() + "\n"
                    ...
                    if (proceed.code() == 401) {
                        ...
                        BaseApplication.getApplication().startActivity(new Intent(BaseApplication.getApplication(), CheckPhoneActivity.class));
                    }
                    return proceed;
                }
...
//            logging.setLevel(HttpLoggingInterceptor.Level.BODY);
            return new OkHttpClient.Builder().connectTimeout(60, TimeUnit.SECONDS).readTimeout(60, TimeUnit.SECONDS).writeTimeout(20, TimeUnit.SECONDS).addInterceptor(logging).addInterceptor(new Interceptor() {
                ...
                public Response intercept(Chain chain) throws IOException {
                    ...
                    Logger.i("header" +  "jsessionid = " + cacheData.result.sessionId + "\n"
