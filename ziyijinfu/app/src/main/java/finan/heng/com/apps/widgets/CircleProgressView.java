...
import finan.heng.com.apps.utils.DensityUtils;
...
public class CircleProgressView extends View {
    ...
    public CircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = ta.getColor(R.styleable.CircleProgressView_progressTextColor, Color.parseColor("#4F5F6F"));
        ...
        progressDefaultColor = ta.getColor(R.styleable.CircleProgressView_progressDefaultColor, Color.LTGRAY);
        ...
        mArcBackPaint.setColor(progressDefaultColor);
...
//                getHeight() / 2 - progressTextHeight / 2 - mTextRect.height(), mLabelTextPaint);
    ...
    /**
     * 设置进度条的默认颜色
     * @param progressDefaultColor 默认颜色数值
     */
